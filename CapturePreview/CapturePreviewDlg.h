...
public:
	...
	afx_msg void			OnRecordingFormatChanged();
...
protected:
	...
	BMDPixelFormat			GetSelectedCapturePixelFormat();
	RecordingMode			GetSelectedRecordingMode();
	void					RefreshRecordingInterface();
	void					StartRecording();
	void					StopRecording();
	...
	CComboBox				m_capturePixelFormatCombo;
	CComboBox				m_recordingFormatCombo;
	CEdit					m_outputPathEdit;
	CButton				m_browseOutputButton;
	CButton				m_recordButton;
	CStatic				m_recordingStatus;
