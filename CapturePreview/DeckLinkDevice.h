...
public:
	...
	bool								startCapture(BMDDisplayMode displayMode, IDeckLinkScreenPreviewCallback* screenPreviewCallback, bool applyDetectedInputMode, BMDPixelFormat requestedPixelFormat = bmdFormatUnspecified);
	void								stopCapture();
